            ...
            <div className="collapse navbar-collapse" id="navbarScroll">
                <ul className="navbar-nav ms-auto me-auto my-2 my-lg-0 navbar-nav-scroll fw-bold" style={{"--bs-scroll-height":"100px;"}}>
                       ...
                       <Link to="/" className=" text-decoration-none"> <a className="nav-link active" aria-current="page" href="#">Home</a> </Link>
                        ...
                        <li className="nav-item">
                       <Link to="prodect" className=" text-decoration-none"> <a className="nav-link" href="#">Prodect</a> </Link>
                        </li>
                        <li className="nav-item">
                        <Link to="contact" className=" text-decoration-none"><a className="nav-link" href="#">Contact</a></Link>
                        </li>
